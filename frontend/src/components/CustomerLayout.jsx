  ...
  return (
    <div className="min-h-screen bg-surface font-body text-on-surface">
      ...
      <div className="flex bg-surface">
        {/* Left sidebar */}
        <aside className="hidden md:flex flex-col w-64 flex-shrink-0 sticky top-20 h-[calc(100vh-5rem)] bg-surface-container-low border-r border-outline-variant/10 py-6">
          {/* User info */}
